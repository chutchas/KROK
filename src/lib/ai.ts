...
11. width = จัดวางให้เหมือนต้นฉบับ: ถ้าเอกสารเรียงช่องเป็น "คอลัมน์เดียว" (บนลงล่าง) ให้ทุกฟิลด์เป็น "full"; ถ้ามีสองช่องสั้นๆ อยู่บรรทัดเดียวกันจริง ให้จับคู่เป็น "half" ทั้งคู่; ฟิลด์ยาว (ชื่อบริษัท, ที่อยู่, รายการสินค้า, หมายเหตุ, ช่องเซ็นชื่อ) ให้ "full" เสมอ
